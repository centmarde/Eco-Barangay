...
export const useAnnouncementsStore = defineStore('announcements', () => {
  ...
  const fetchAnnouncementById = async (id: number) => {
    ...
    try {
      ...
      error.value = err instanceof Error ? err.message : 'Failed to fetch announcement'
  ...
  const fetchRecentAnnouncements = async (limit: number = 5) => {
    ...
    try {
      ...
      error.value = err instanceof Error ? err.message : 'Failed to fetch recent announcements'
  ...
  const searchAnnouncements = async (searchTerm: string) => {
    ...
    try {
      ...
      error.value = err instanceof Error ? err.message : 'Failed to search announcements'
  ...
  const updateAnnouncement = async (id: number, announcementData: UpdateAnnouncementData) => {
    loading.value = true
    error.value = undefined
  ...
  const deleteMultipleAnnouncements = async (ids: number[]) => {
    ...
    try {
      ...
      error.value = err instanceof Error ? err.message : 'Failed to delete announcements'
