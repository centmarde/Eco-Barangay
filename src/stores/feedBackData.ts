...
export const useFeedbackStore = defineStore('feedback', () => {
  ...
  const fetchFeedbacks = async () => {
    ...
    try {
      ...
      error.value = err instanceof Error ? err.message : 'Failed to fetch feedbacks'
  ...
  const fetchFeedbacksByUserId = async (userId: string) => {
    ...
    try {
      ...
      error.value = err instanceof Error ? err.message : 'Failed to fetch feedbacks by user'
  ...
  const fetchFeedbacksByCollectionId = async (collectionId: number) => {
    ...
    try {
      ...
      error.value = err instanceof Error ? err.message : 'Failed to fetch feedbacks by collection'
  ...
  const fetchFeedbacksByRating = async (minRating: number, maxRating?: number) => {
    loading.value = true
    error.value = undefined
    ...
    try {
      ...
      error.value = err instanceof Error ? err.message : 'Failed to fetch feedbacks by rating'
  ...
  const getAverageRatingByCollectionId = async (collectionId: number) => {
    ...
    try {
      ...
      error.value = err instanceof Error ? err.message : 'Failed to calculate average rating'
  ...
  const createFeedback = async (feedbackData: CreateFeedbackData) => {
    ...
    try {
      ...
      error.value = err instanceof Error ? err.message : 'Failed to create feedback'
  ...
  const updateFeedback = async (id: number, feedbackData: UpdateFeedbackData) => {
    loading.value = true
    error.value = undefined
    ...
    try {
      ...
      error.value = err instanceof Error ? err.message : 'Failed to update feedback'
  ...
  const deleteFeedbacksByUserId = async (userId: string) => {
    ...
    try {
      ...
      error.value = err instanceof Error ? err.message : 'Failed to delete user feedbacks'
  ...
  const deleteFeedbacksByCollectionId = async (collectionId: number) => {
    ...
    try {
      ...
      feedbacks.value = feedbacks.value.filter((f) => f.collection_id !== collectionId)
      toast.success('Collection feedbacks deleted successfully')
      return true
    } catch (err) {
      error.value = err instanceof Error ? err.message : 'Failed to delete collection feedbacks'
